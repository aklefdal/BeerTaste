...
let view (beerTasteGuid: string) (language: Language) (firebaseConfig: FirebaseConfig option) (tasters: Taster list) =
    let t = getTranslations language

    layout t.Tasters beerTasteGuid language firebaseConfig [
        h1 () { raw t.Tasters }
